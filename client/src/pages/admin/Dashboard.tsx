...
export default function AdminDashboard() {
  ...
  return (
    <div className="mx-auto space-y-8 font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex gap-1 bg-gray-50 dark:bg-gray-800 rounded-xl p-1.5 self-start sm:self-auto border border-gray-200 dark:border-gray-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-7">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2 text-sm text-teal-600 dark:text-teal-400 font-semibold bg-teal-50 dark:bg-teal-900/30 px-3 py-1.5 rounded-lg">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-7 flex flex-col">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
          ...
          <Link
            to="/admin/orders"
            className="mt-5 flex items-center justify-center gap-2 py-2.5 rounded-xl border-2 border-teal-100 dark:border-teal-800 text-teal-700 dark:text-teal-400 text-sm font-semibold hover:bg-teal-50 dark:hover:bg-teal-900/20 transition-colors"
          >
            View all orders →
          </Link>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-orange-100 dark:border-orange-900 shadow-sm p-7">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="ml-auto text-xs font-bold bg-orange-100 dark:bg-orange-900/40 text-orange-600 dark:text-orange-400 px-2.5 py-1 rounded-full">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-7">
          ...
          <div className="space-y-1">
            {topProducts.map((p, i) => (
              <div
                key={p.id}
                className="flex items-center gap-4 px-4 py-3.5 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors"
              >
...
function KpiCard({
  ...
  return (
    <div className={`bg-white dark:bg-gray-800 rounded-2xl border ${accentStyles[accent].border} shadow-sm p-6 flex flex-col gap-4`}>
      <div className="flex items-center justify-between">
        <div className={`p-2.5 rounded-xl ${accentStyles[accent].icon}`}>{icon}</div>
        <span
      ...
      <p className="text-xs text-gray-300 dark:text-gray-600 font-medium">{trendLabel}</p>
    </div>
  );
}
...
function StatusBadge({ status }: { status: string }) {
  ...
  return (
    <span className={`text-xs font-semibold px-2 py-0.5 rounded-md ${map[status] ?? 'bg-gray-50 dark:bg-gray-700 text-gray-500 dark:text-gray-400'}`}>
      {status}
    </span>
  );
}